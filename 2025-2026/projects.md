## Project 1
<details>
    <summary> Certificate medicale <img style="vertical-align:middle" src="images\certif.png" width="100"/></summary>

### Scop

Scop:
Extragerea informatiilor din formularul "Certificar de concediu medical" si pregatirea lor pentru import in aplicatie de HR.

### Ideea de baza

Identificarea informatiilor din formularul Certificat de concediu medical este dificila, deoarece aceasta poate fi prezentata in doua feluri: tiparit la imprimanta si scris de mana. Complexitatea creste, avand in vedere erorile de imprimare datorata alinierii gresite a hartiei, erori care duc la imprimarea informatiei in afara casutelor aferente, iar in cazul certificatelor scrise de mana, remarcam ca in cazul certificatelor scrise de medici, informatia este mai dificil de interpretat decat in cazul certificatelor completate de asistente. Lunar se proceseaza in Romania, zeci de mii de formulare de catre operatori umani. Extragerea automata a informatiilor si prezentarea lor pentru import in aplicatii ar simplifica cu mult munca acestora.
Informatia ar trebui prezentata intr-un fisier excel cu sturctura coloanelor prezentata de noi.

Informatii utile:
- fisa de Certificat de concediu medical cu numerotara campurilor [link](2025-2026\Projects\medicalCertificates\example.jpg)
- fisierul excel cu doua pagini, una care se explica toate campurile din Certificat si a doua care precizeaza doar campurile care sunt necesare intr-o aplicatie de HR [link](2025-2026\Projects\medicalCertificates\example.xlsx)
...
- set de certificate medicale anonimizate [link](2025-2026\Projects\medicalCertificates\certificate.zip)

### Bibliografie
- OCR tools / algorithms [link1](https://blog.roboflow.com/best-ocr-models-text-recognition/) [link2](https://github.com/tesseract-ocr/tesseract)
