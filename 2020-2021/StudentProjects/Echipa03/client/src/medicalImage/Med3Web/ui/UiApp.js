...
import { Nav, Navbar, Container, ProgressBar, Row, Col, NavItem } from 'react-bootstrap';
...
class UiApp extends React.Component {
  ...
  render() {
    ...
    const strMessageOnMenu = (isLoaded) ? 'File: ' + fileName : 'Press Open button to load a scene';
